    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('dist/img/D.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Jasa Joki</span>
            </a>

            <!-- Sidebar -->
            <div class="sidebar" style="min-height: 860px;">
                <!-- Sidebar user panel (optional) -->
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('dist/img/sanji.jpg')}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
